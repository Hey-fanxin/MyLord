(function(window, $){
    function Renderer(){
        ...
        this.MAX_ROTATION_ANGLE = Math.PI / 60;
        this.TRANSLATION_COUNT = 500;
    }
    Renderer.prototype.init = function(strategy){
    ...
    Renderer.prototype.setParameters = function (strategy) {
        this.$window = $(window);

        this.$container = $('#canvasbox2');
    ...
    Renderer.prototype.createParticles = function () {
        for (var i = 0; i < this.PARTICLE_COUNT; i++) {
            this.particles.push(new PARTICLE(this.center));
        }
    }
    Renderer.prototype.reconstructMethod = function () {
    ...
    Renderer.prototype.changeAngle = function (event) {
    ...
    Renderer.prototype.setupFigure = function () {
    ...
    Renderer.prototype.drawFigure = function () {
        requestAnimationFrame(this.drawFigure);

        this.context.fillStyle = 'rgba(33, 33, 33, 0.6)';
        ...
        for (var i = 0, length = this.particles.length; i < length; i++) {
            ...
            this.context.arc(axis.x, axis.y, this.PARTICLE_RADIUS, 0, Math.PI * 1, false);
            this.context.fill();
        }
        this.theta++;
        this.theta %= 360;
